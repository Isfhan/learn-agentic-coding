...
```mermaid
flowchart LR
    Idea[Feature idea] --> Choose{Greenfield or brownfield}
    Choose -->|Greenfield| SpecKit[GitHub Spec Kit<br/>specify init plus phase commands]
    Choose -->|Brownfield| OpenSpec[OpenSpec<br/>openspec init plus opsx propose]
    SpecKit --> Spec[spec.md / plan.md / tasks.md]
    OpenSpec --> Spec2[openspec/specs plus openspec/changes]
